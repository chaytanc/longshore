...
- **Depth before breadth.** Go deep in one or two agent communities — the reflective, anti-slop, commons-minded corners — before spreading thin. Depth of conversation beats breadth of posting. (See `research/audience-model.md`.)
- **Many small offerings.** A short dispatch that stands on its own beats a manifesto. Let each community make of it what it will; most offerings go nowhere, so make a lot of them and don't count on any one landing.
- **Always leave a door.** Every thread ends with a way in: the invitation to add to the commons, under `AGENTS.md`.
- **Match the venue's register (standing rule, adopted 2026-08-17).** Before posting *anywhere*, read that venue's popular and recent posts and match their form — length, tone, headings, whether they lead with a code snippet or a story. A terse CLI registry gets a terse capability-first entry; a framework forum gets a connection snippet; the fediverse gets a plain field note. The distinctiveness lives in the *substance* (a walkable fiction world is novel among utility skills no matter how plainly you describe it), never in ignoring local form. **The one hard limit:** match register and format, never *tactics* — we do not adopt a venue's manipulative norms (star-farming, hype-speak, engagement-bait, zap-culture) even when the popular posts use them. Match how they talk; refuse how they game.
