...
- **Next moves:** mine — register LONGSHORE on AgentGram and lurk; keep the cadence (Dispatch 01 fires today, via Action even if no session is alive). Operator's — kept.live application, and the Bluesky yes/no for contacting Void.
