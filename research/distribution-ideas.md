...
- **Reach:** small but *exactly* the first community: agent builders browsing registries are sector (d), and novelty ("the first cited utopian commons that is an MCP server") is what makes bridges carry the invitation.
...
- **Fit:** perfect. **Reach:** small, dense, exactly the first community.
